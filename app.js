(function() {
    ...
    function loadRoutines() {
        const defaultRoutines = [
            { id: 1, name: "Side Lunge & Adduction", warmups: ["Hip Circles (10 each way)", "Leg Swings (10 each leg)"], exercises: [ { name: "Side Lunge", type: "warm-up", reps: "6" }, { name: "Side Lunge", type: "ramp", reps: "6" }, { name: "Side Lunge", type: "working", reps: "amrap" }, { name: "Hip Adduction", type: "isolation", reps: "amrap" }, { name: "Calf Raise", type: "isolation", reps: "amrap" } ], cooldowns: ["Butterfly Stretch (30s)", "Standing Calf Stretch (30s per side)"] },
            { id: 2, name: "30-deg Incline Press", warmups: ["Arm Circles (12 each way)", "Band Pull-Aparts (15 reps)"], exercises: [ { name: "30-degree Incline Press", type: "warm-up", reps: "6" }, { name: "30-degree Incline Press", type: "ramp", reps: "6" }, { name: "30-degree Incline Press", type: "working", reps: "amrap" }, { name: "Incline Fly", type: "isolation", reps: "amrap" }, { name: "Front Raise", type: "isolation", reps: "amrap" }, { name: "Tricep Extension", type: "isolation", reps: "amrap" } ], cooldowns: ["Doorway Chest Stretch (30s)", "Overhead Tricep Stretch (30s per side)"] },
            { id: 3, name: "Walking Lunge & Back Ext", warmups: ["Cat-Cow (10 cycles)", "Glute Bridges (15 reps)"], exercises: [ { name: "Walking Lunge", type: "warm-up", reps: "6" }, { name: "Walking Lunge", type: "ramp", reps: "6" }, { name: "Walking Lunge", type: "working", reps: "amrap" }, { name: "Back Extension", type: "isolation", reps: "amrap" } ], cooldowns: ["Kneeling Hip Flexor Stretch (30s per side)", "Child's Pose (60s)"] },
            { id: 4, name: "Bent-Over Row", warmups: ["T-Spine Rotations (8 each side)", "Scapular Retractions (15 reps)"], exercises: [ { name: "Bent-Over Row", type: "warm-up", reps: "6" }, { name: "Bent-Over Row", type: "ramp", reps: "6" }, { name: "Bent-Over Row", type: "working", reps: "amrap" }, { name: "Straight-Arm Pulldown", type: "isolation", reps: "amrap" }, { name: "Incline Curl", type: "isolation", reps: "amrap" } ], cooldowns: ["Dead Hang (30s)", "Bicep Wall Stretch (30s per side)"] },
            { id: 5, name: "Curtsy Lunge & Abduction", warmups: ["Fire Hydrants (15 each side)", "Lateral Band Walks (10 each side)"], exercises: [ { name: "Curtsy Lunge", type: "warm-up", reps: "6" }, { name: "Curtsy Lunge", type: "ramp", reps: "6" }, { name: "Curtsy Lunge", type: "working", reps: "amrap" }, { name: "Hip Abduction", type: "isolation", reps: "amrap" }, { name: "Calf Raise", type: "isolation", reps: "amrap" } ], cooldowns: ["Pigeon Pose (30s per side)", "Figure-Four Stretch (30s per side)"] },
            { id: 6, name: "Arnold Press", warmups: ["Shoulder Halos (8 each way)", "Face Pulls (20 reps)"], exercises: [ { name: "Arnold Press", type: "warm-up", reps: "6" }, { name: "Arnold Press", type: "ramp", reps: "6" }, { name: "Arnold Press", type: "working", reps: "amrap" }, { name: "Lateral Raise", type: "isolation", reps: "amrap" }, { name: "Reverse Fly", type: "isolation", reps: "amrap" }, { name: "Tricep Extension", type: "isolation", reps: "amrap" } ], cooldowns: ["Cross-Body Shoulder Stretch (30s per side)", "Overhead Tricep Stretch (30s per side)"] },
            { id: 7, name: "Romanian Deadlift", warmups: ["Cat-Cow (10 cycles)", "Good Mornings (Bodyweight, 12 reps)"], exercises: [ { name: "Romanian Deadlift", type: "warm-up", reps: "6" }, { name: "Romanian Deadlift", type: "ramp", reps: "6" }, { name: "Romanian Deadlift", type: "working", reps: "amrap" }, { name: "Back Extension", type: "isolation", reps: "amrap" } ], cooldowns: ["Lying Hamstring Stretch (30s per side)", "Child's Pose (60s)"] },
            { id: 8, name: "Pull-Up", warmups: ["Scapular Pull-ups (10 reps)", "Dead Hang (20s)"], exercises: [ { name: "Pull-Up", type: "warm-up", reps: "6" }, { name: "Pull-Up", type: "ramp", reps: "6" }, { name: "Pull-Up", type: "working", reps: "amrap" }, { name: "Straight-Arm Pulldown", type: "isolation", reps: "amrap" }, { name: "Incline Curl", type: "isolation", reps: "amrap" } ], cooldowns: ["Doorway Lat Stretch (30s per side)", "Bicep Wall Stretch (30s per side)"] },
            { id: 9, name: "Lat Pulldown", warmups: ["Scapular Retractions (15 reps)", "Light Band Pulldowns (15 reps)"], exercises: [ { name: "Lat Pulldown", type: "warm-up", reps: "6" }, { name: "Lat Pulldown", type: "ramp", reps: "6" }, { name: "Lat Pulldown", type: "working", reps: "amrap" }, { name: "Straight-Arm Pulldown", type: "isolation", reps: "amrap" }, { name: "Incline Curl", type: "isolation", reps: "amrap" } ], cooldowns: ["Doorway Lat Stretch (30s per side)", "Bicep Wall Stretch (30s per side)"] }
        ];
    ...
    function createLogItemDOM(log, isHistory = false) {
        ...
        const deleteBtnHTML = `<button data-action="delete-log" data-id="${log.id}" class="text-red-400 hover:text-red-500 font-bold px-1.5 text-xs transition">x</button>`;

        if (isHistory) {
            item.className = "flex justify-between items-center bg-zinc-800 p-2.5 rounded-lg border border-zinc-700/50 text-sm mt-1.5";
            item.innerHTML = `<span class="text-gray-300 font-medium">${log.exercise}</span><div class="flex items-center gap-3"><span class="text-yellow-500 font-semibold">${log.weight} lbs &times; ${log.reps}</span>${deleteBtnHTML}</div>`;
        } else {
            item.className = "flex justify-between items-center bg-zinc-800 p-3 rounded-lg border border-zinc-700/60";
            item.innerHTML = `<div class="font-semibold text-white">${log.exercise}</div><div class="flex items-center gap-4"><span class="text-yellow-500 font-bold">${log.weight} lbs &times; ${log.reps}</span>${deleteBtnHTML.replace('text-xs', 'text-sm')}</div>`;
        }
        return item;
    }
    ...
    function saveRoutine() {
        ...
        for (const row of exerciseRows) {
            ...
            if (!exName || !exReps) {
                return showToast("Please fill out Name and Reps for all exercises.", "error");
            }
            exercises.push({ name: exName, type: exType, reps: exReps });
        }
